...
void ChassisState::CAN_Setting()
{
    ...
    Motor3508.setMSD(&msd_3508_2006, pid_vel_0x203.pid.cout, Get_MOTOR_SET_ID_3508(0x203));
    Motor3508.setMSD(&msd_3508_2006, pid_vel_0x204.pid.cout, Get_MOTOR_SET_ID_3508(0x204));
}
