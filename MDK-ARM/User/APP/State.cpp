...
//    getMinPos[1] = Motor6020.MinPosHelm(tar_vx.x1, Motor6020.GetEquipData(L_Back_ID   , Dji_Speed), &tar_speed[0], 8191, 8191);
//    getMinPos[2] = Motor6020.MinPosHelm(tar_vx.x1, Motor6020.GetEquipData(R_Back_ID   , Dji_Speed), &tar_speed[0], 8191, 8191);
//    getMinPos[3] = Motor6020.MinPosHelm(tar_vx.x1, Motor6020.GetEquipData(R_Forward_ID, Dji_Speed), &tar_speed[0], 8191, 8191);
//    //过零处理
